...
*/
  ...
  * @param file_offset the start offset of the file
	...
	*/
	protected synchronized boolean newWritableStorageConnection(String group_name) throws IOException, MyException
	{
	...
	*/
	...
	boolean validate() throws  Exception{
		return isConnected(storageServer.getSocket()) && isConnected(trackerServer.getSocket());
	}
